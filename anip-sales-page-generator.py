...
def create_stripe_payment_link(product_data: dict, price: int = 2997) -> str:
    ...
    try:
        ...
        print(error_msg)
        return f"javascript:alert('Payment system configuration error. Please contact support.')"
        
    except stripe.error.InvalidRequestError as e:
        error_msg = f"STRIPE INVALID REQUEST ERROR: {str(e)}"
        print(error_msg)
        return f"javascript:alert('Payment request error. Please try again.')"
        
    except stripe.error.PermissionError as e:
        error_msg = f"STRIPE PERMISSION ERROR: {str(e)} - API key may not have required permissions"
        print(error_msg)
        return f"javascript:alert('Payment permission error. Please contact support.')"
